---
layout: writeup.html
title: Detecting Reverse Shells
...
1. Shell spawned on target device from anomalous parent
2. Outbound connection to C2 server
3. Command execution on the target device
...
The troubleshooting process was more instructive than if everything had worked perfectly the first time.  
Happy Hunting!